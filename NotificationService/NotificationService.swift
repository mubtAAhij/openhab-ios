                        ...
                        if let firstMatch = state.firstMatch(of: pattern) {
                            ...
                            if let imageData = Data(base64Encoded: base64String) {
                                ...
                                do {
                                    ...
                                    os_log("String(localized: "image_saved_temp_file", comment: "Debug message for image saved to temporary file")", log: .default, type: .info, tempFileURL.absoluteString)

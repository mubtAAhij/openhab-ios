...
public enum NetworkStatus: String {
    case notConnected = String(localized: "not_connected", comment: "Network connection status when not connected")
    case connecting = "Connecting"
    case connected = String(localized: "connected", comment: "Network connection status when connected")
}

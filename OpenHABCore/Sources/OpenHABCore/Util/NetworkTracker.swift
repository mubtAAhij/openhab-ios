...
public enum NetworkStatus: String {
    case notConnected = NSLocalizedString("not_connected", comment: "Network not connected status")
    case connecting = "Connecting"
    case connected = NSLocalizedString("connected", comment: "Network connected status")
}

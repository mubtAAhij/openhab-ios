...
public enum NetworkStatus: String {
    case notConnected = NSLocalizedString("not_connected", comment: "Network status: not connected")
    case connecting = "Connecting"
    case connected = NSLocalizedString("connected", comment: "Network status: connected")
}

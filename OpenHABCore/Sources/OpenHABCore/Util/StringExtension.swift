...
public extension String {
    ...
    func parseAsBool() -> Bool {
        if self == "NSLocalizedString("on", comment: "ON state")" { return true }
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case "NSLocalizedString("on", comment: "ON state")": return NumberState(value: 100.0)
        case "NSLocalizedString("off", comment: "OFF state")": return NumberState(value: 0.0)
        default:

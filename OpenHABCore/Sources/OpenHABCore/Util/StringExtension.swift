...
public extension String {
    ...
    func parseAsBool() -> Bool {
        if self == String(localized: "on", comment: "Switch on state") { return true }
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case String(localized: "on", comment: "Switch on state"): return NumberState(value: 100.0)
        case String(localized: "off", comment: "Switch off state"): return NumberState(value: 0.0)
        default:

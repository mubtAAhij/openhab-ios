...
public extension String {
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case String(localized: "on", comment: "ON state for boolean parsing"): return NumberState(value: 100.0)
        case String(localized: "off", comment: "OFF state for boolean parsing"): return NumberState(value: 0.0)
        default:

...
public extension String {
    ...
    func parseAsBool() -> Bool {
        if self == "String(localized: "on_value", comment: "ON value in string extension")" { return true }
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case "String(localized: "on_value", comment: "ON value in string extension")": return NumberState(value: 100.0)
        case "String(localized: "off_value", comment: "OFF value in string extension")": return NumberState(value: 0.0)
        default:

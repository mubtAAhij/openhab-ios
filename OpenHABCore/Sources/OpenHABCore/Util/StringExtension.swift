...
public extension String {
    ...
    func parseAsBool() -> Bool {
        if self == "String(localized: "on_state", comment: "ON state for switch")" { return true }
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case "String(localized: "on_state", comment: "ON state for switch")": return NumberState(value: 100.0)
        case "String(localized: "off_state", comment: "OFF state for switch")": return NumberState(value: 0.0)
        default:

...
public extension String {
    ...
    func parseAsBool() -> Bool {
        if self == String(localized: "on", comment: "Switch state ON") { return true }
    ...
    func parseAsNumber(format: String? = nil) -> NumberState {
        switch self {
        case String(localized: "on", comment: "Switch state ON"): return NumberState(value: 100.0)
        case String(localized: "off", comment: "Switch state OFF"): return NumberState(value: 0.0)
        default:

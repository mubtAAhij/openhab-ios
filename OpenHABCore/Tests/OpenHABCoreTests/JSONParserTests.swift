...
final class JSONParserTests: XCTestCase {
    ...
    func testJSONLargeSitemapParseSwift() throws {
        ...
        if #available(iOS 12, *) {
            ...
            os_signpost(
                ...
                name: "Decode JSON",
                signpostID: signpostID,
                String(localized: "end", comment: "End label for testing")
            )
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, String(localized: "off", comment: "OFF state for testing"), "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: String(localized: "on", comment: "ON state for testing")), 1, "Checking finding of command")

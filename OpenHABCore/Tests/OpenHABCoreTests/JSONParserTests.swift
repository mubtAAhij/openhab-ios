...
final class JSONParserTests: XCTestCase {
    ...
    func testJSONLargeSitemapParseSwift() throws {
        ...
        if #available(iOS 12, *) {
            ...
            os_signpost(
                ...
                name: "Decode JSON",
                signpostID: signpostID,
                NSLocalizedString("end", comment: "End label for tests")
            )
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, NSLocalizedString("off", comment: "Switch state OFF"), "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: NSLocalizedString("on", comment: "Switch state ON")), 1, "Checking finding of command")

...
final class JSONParserTests: XCTestCase {
    ...
    func testJSONLargeSitemapParseSwift() throws {
        ...
        if #available(iOS 12, *) {
            ...
            os_signpost(
                ...
                name: "Decode JSON",
                signpostID: signpostID,
                "String(localized: "end_label", comment: "End label")"
            )
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, "String(localized: "off_state", comment: "OFF state for switch")", "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: "String(localized: "on_state", comment: "ON state for switch")"), 1, "Checking finding of command")

...
final class JSONParserTests: XCTestCase {
    ...
    func testJSONLargeSitemapParseSwift() throws {
        ...
        if #available(iOS 12, *) {
            ...
            os_signpost(
                ...
                name: "Decode JSON",
                signpostID: signpostID,
                NSLocalizedString("end", comment: "End label for test")
            )
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, NSLocalizedString("off", comment: "OFF state for test"), "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: NSLocalizedString("on", comment: "ON state for test")), 1, "Checking finding of command")

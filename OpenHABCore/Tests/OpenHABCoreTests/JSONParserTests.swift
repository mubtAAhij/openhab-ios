...
final class JSONParserTests: XCTestCase {
    ...
    func testJSONLargeSitemapParseSwift() throws {
        ...
        if #available(iOS 12, *) {
            ...
            os_signpost(
                ...
                name: "Decode JSON",
                signpostID: signpostID,
                String(localized: "end", comment: "End label")
            )
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, String(localized: "off", comment: "OFF state"), "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: String(localized: "on", comment: "ON state")), 1, "Checking finding of command")

...
final class JSONParserTests: XCTestCase {
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, "String(localized: "off", comment: "OFF test value")", "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: "String(localized: "on", comment: "ON test value")"), 1, "Checking finding of command")

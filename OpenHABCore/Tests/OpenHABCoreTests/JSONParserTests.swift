...
final class JSONParserTests: XCTestCase {
    ...
    func testItemWithDescription() {
        ...
        do {
            ...
            XCTAssertEqual(widget.mappingsOrItemOptions[0].command, String(localized: "off", comment: "Switch off state"), "Checking assignment of stateDescription")
            XCTAssertEqual(widget.mappingIndex(byCommand: String(localized: "on", comment: "Switch on state")), 1, "Checking finding of command")

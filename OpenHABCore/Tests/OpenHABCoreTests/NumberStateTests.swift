...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual("String(localized: "on_state", comment: "ON state for switch")".parseAsBool(), true)
        ...
        XCTAssertEqual("String(localized: "on_state", comment: "ON state for switch")".parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual("String(localized: "off_state", comment: "OFF state for switch")".parseAsNumber(), NumberState(value: 0.0))

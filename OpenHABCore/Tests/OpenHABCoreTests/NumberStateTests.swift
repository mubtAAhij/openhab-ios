...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual("String(localized: "on", comment: "ON state in test")".parseAsBool(), true)
        ...
        XCTAssertEqual("String(localized: "on", comment: "ON state in test")".parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual("String(localized: "off", comment: "OFF state in test")".parseAsNumber(), NumberState(value: 0.0))

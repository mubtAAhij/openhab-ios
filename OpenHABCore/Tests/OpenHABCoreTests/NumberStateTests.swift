...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual(String(localized: "on", comment: "Switch state ON").parseAsBool(), true)
        ...
        XCTAssertEqual(String(localized: "on", comment: "Switch state ON").parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual(String(localized: "off", comment: "Switch state OFF").parseAsNumber(), NumberState(value: 0.0))

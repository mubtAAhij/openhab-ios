...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual(NSLocalizedString("on", comment: "Switch state ON").parseAsBool(), true)
        ...
        XCTAssertEqual(NSLocalizedString("on", comment: "Switch state ON").parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual(NSLocalizedString("off", comment: "Switch state OFF").parseAsNumber(), NumberState(value: 0.0))

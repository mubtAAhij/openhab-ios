...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual(String(localized: "on", comment: "ON state for testing").parseAsBool(), true)
        ...
        XCTAssertEqual(String(localized: "on", comment: "ON state for testing").parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual(String(localized: "off", comment: "OFF state for testing").parseAsNumber(), NumberState(value: 0.0))

...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual(String(localized: "on", comment: "ON state").parseAsBool(), true)
        ...
        XCTAssertEqual(String(localized: "on", comment: "ON state").parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual(String(localized: "off", comment: "OFF state").parseAsNumber(), NumberState(value: 0.0))

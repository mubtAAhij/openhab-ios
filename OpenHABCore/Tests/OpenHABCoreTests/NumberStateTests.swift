...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual("String(localized: "on_test_value", comment: "ON test value")".parseAsBool(), true)
        ...
        XCTAssertEqual("String(localized: "on_test_value", comment: "ON test value")".parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual("String(localized: "off_test_value", comment: "OFF test value")".parseAsNumber(), NumberState(value: 0.0))

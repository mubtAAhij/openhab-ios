...
final class NumberStateTests: XCTestCase {
    ...
    func testParseAs() throws {
        XCTAssertEqual("NSLocalizedString("on", comment: "ON state in test")".parseAsBool(), true)
        ...
        XCTAssertEqual("NSLocalizedString("on", comment: "ON state in test")".parseAsNumber(), NumberState(value: 100.0))
        XCTAssertEqual("NSLocalizedString("off", comment: "OFF state in test")".parseAsNumber(), NumberState(value: 0.0))

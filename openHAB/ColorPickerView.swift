...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("String(format: String(localized: "hue_value", comment: "Hue display label"), hue)")
            Text("String(format: String(localized: "saturation_value", comment: "Saturation display label"), saturation)")
            Text("String(format: String(localized: "brightness_value", comment: "Brightness display label"), brightness)")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(format: String(localized: "sending_command", comment: "Debug log for command being sent"), command)")

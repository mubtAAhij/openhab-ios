...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("String(localized: "hue_value", comment: "Hue color component display")")
            Text("String(localized: "saturation_value", comment: "Saturation color component display")")
            Text("String(localized: "brightness_value", comment: "Brightness color component display")")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(localized: "sending_command", comment: "Debug log for command being sent")")

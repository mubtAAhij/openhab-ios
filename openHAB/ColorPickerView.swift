...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker("String(localized: "pick_color", comment: "Color picker label")", selection: $selectedColor)
            ...
            Text("String(localized: "hue_value", comment: "Hue display label with value")")
            Text("String(localized: "saturation_value", comment: "Saturation display label with value")")
            Text("String(localized: "brightness_value", comment: "Brightness display label with value")")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(localized: "sending_command", comment: "Debug log when sending command")")

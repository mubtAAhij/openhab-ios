...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text(String(localized: "hue_value", comment: "Hue color value display").replacingOccurrences(of: "%@", with: String(format: "%.2f", hue)))
            Text(String(localized: "saturation_value", comment: "Saturation color value display").replacingOccurrences(of: "%@", with: String(format: "%.2f", saturation)))
            Text(String(localized: "brightness_value", comment: "Brightness color value display").replacingOccurrences(of: "%@", with: String(format: "%.2f", brightness)))
        }
        .onAppear {

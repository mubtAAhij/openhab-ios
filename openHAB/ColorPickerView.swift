...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker(String(localized: "pick_color", comment: "Color picker selection prompt"), selection: $selectedColor)
            ...
            Text(String(localized: "hue_value", comment: "Hue color component display").replacingOccurrences(of: "%@", with: String(format: "%.2f", hue)))
            Text(String(localized: "saturation_value", comment: "Saturation color component display").replacingOccurrences(of: "%@", with: String(format: "%.2f", saturation)))
            Text(String(localized: "brightness_value", comment: "Brightness color component display").replacingOccurrences(of: "%@", with: String(format: "%.2f", brightness)))
        }
        .onAppear {

...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker("String(localized: "pick_color", comment: "Title for color picker interface")", selection: $selectedColor)
            ...
            Text("String(localized: "hue_value", comment: "Hue value display with formatting") + ": \(hue, specifier: "%.2f")")
            Text("String(localized: "saturation_value", comment: "Saturation value display with formatting") + ": \(saturation, specifier: "%.2f")")
            Text("String(localized: "brightness_value", comment: "Brightness value display with formatting") + ": \(brightness, specifier: "%.2f")")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(localized: "sending_command", comment: "Debug log for sending command") + ": \(command)"")

...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker("String(localized: "pick_a_color", comment: "Title for color picker")", selection: $selectedColor)
            ...
            Text("String(localized: "hue_value", comment: "Label showing hue value")")
            Text("String(localized: "saturation_value", comment: "Label showing saturation value")")
            Text("String(localized: "brightness_value", comment: "Label showing brightness value")")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(localized: "sending_command", comment: "Debug message showing command being sent")")

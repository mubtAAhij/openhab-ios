...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker(String(localized: "pick_color", comment: "Color picker selection label"), selection: $selectedColor)
            ...
            Text(String(localized: "hue_value", comment: "Label showing hue color value"))
            Text(String(localized: "saturation_value", comment: "Label showing saturation color value"))
            Text(String(localized: "brightness_value", comment: "Label showing brightness color value"))
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug(String(localized: "sending_command", comment: "Debug log message for command being sent"))

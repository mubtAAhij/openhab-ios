...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("String(localized: "hue_value", comment: "Hue display label").replacingOccurrences(of: "%@", with: String(format: "%.2f", hue))")
            Text("String(localized: "saturation_value", comment: "Saturation display label").replacingOccurrences(of: "%@", with: String(format: "%.2f", saturation))")
            Text("String(localized: "brightness_value", comment: "Brightness display label").replacingOccurrences(of: "%@", with: String(format: "%.2f", brightness))")
        }
        .onAppear {

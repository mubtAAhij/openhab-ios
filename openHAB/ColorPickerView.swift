...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text(String(localized: "hue_value", comment: "Hue display with value"))
            Text(String(localized: "saturation_value", comment: "Saturation display with value"))
            Text(String(localized: "brightness_value", comment: "Brightness display with value"))
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug(String(localized: "sending_command", comment: "Debug log message for sending command"))

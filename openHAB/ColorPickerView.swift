...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker(NSLocalizedString("pick_a_color", comment: "Color picker title"), selection: $selectedColor)
            ...
            Text(String(format: NSLocalizedString("hue_value", comment: "Hue display label"), hue))
            Text(String(format: NSLocalizedString("saturation_value", comment: "Saturation display label"), saturation))
            Text(String(format: NSLocalizedString("brightness_value", comment: "Brightness display label"), brightness))
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug(NSLocalizedString("sending_command", comment: "Debug log for sending command"), command)

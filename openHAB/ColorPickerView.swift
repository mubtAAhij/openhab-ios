...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("String(localized: "hue_value", comment: "Hue value display")")
            Text("String(localized: "saturation_value", comment: "Saturation value display")")
            Text("String(localized: "brightness_value", comment: "Brightness value display")")
        }
        .onAppear {
    ...
    func sendColorUpdate() {
        ...
        logger.debug("String(localized: "sending_command_debug", comment: "Debug message for command sending")")

...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text(String(localized: "hue_value", comment: "Hue value display").replacingOccurrences(of: "{value}", with: String(format: "%.2f", hue)))
            Text(String(localized: "saturation_value", comment: "Saturation value display").replacingOccurrences(of: "{value}", with: String(format: "%.2f", saturation)))
            Text(String(localized: "brightness_value", comment: "Brightness value display").replacingOccurrences(of: "{value}", with: String(format: "%.2f", brightness)))
        }
        .onAppear {

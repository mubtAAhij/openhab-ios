...
struct ColorPickerView: View {
    ...
    var body: some View {
        VStack {
            ...
            ColorPicker(String(localized: "pick_color", comment: "Color picker dialog title"), selection: $selectedColor)
            ...
            Text(String(localized: "hue_value", comment: "Hue value display label").replacingOccurrences(of: "{value}", with: String(format: "%.2f", hue)))
            Text(String(localized: "saturation_value", comment: "Saturation value display label").replacingOccurrences(of: "{value}", with: String(format: "%.2f", saturation)))
            Text(String(localized: "brightness_value", comment: "Brightness value display label").replacingOccurrences(of: "{value}", with: String(format: "%.2f", brightness)))
        }
        .onAppear {

...
class ColorPickerViewController: DefaultColorPickerViewController {
    ...
    func sendColorUpdate(color: UIColor) {
        ...
        os_log("String(format: NSLocalizedString("color_changed_hsb", comment: "Log message for color change with HSB values"), hue, saturation, brightness)", log: .default, type: .info, hue, saturation, brightness)

...
class ColorPickerViewController: DefaultColorPickerViewController {
    ...
    func sendColorUpdate(color: UIColor) {
        ...
        os_log("String(localized: "color_changed_hsb_format", comment: "Debug log message for color change with HSB values")", log: .default, type: .info, hue, saturation, brightness)

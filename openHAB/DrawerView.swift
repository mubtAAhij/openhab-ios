...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "main", comment: "Main navigation label"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "tiles", comment: "Tiles navigation label"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "sitemaps", comment: "Sitemaps navigation label"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "system", comment: "System navigation label"))) {
                HStack {
    ...
    @State private var connectedUrl: String = String(localized: "not_connected", comment: "Connection status message") // Default label text
    @ObservedObject private var networkTracker = NetworkTracker.shared

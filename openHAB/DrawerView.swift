...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "main_menu", comment: "Main menu item")")) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "tiles_menu", comment: "Tiles menu item")")) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "sitemaps_menu", comment: "Sitemaps menu item")")) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "system_menu", comment: "System menu item")")) {
                HStack {
    ...
    @State private var connectedUrl: String = "String(localized: "not_connected_status", comment: "Not connected status message")" // Default label text
    @ObservedObject private var networkTracker = NetworkTracker.shared

...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(NSLocalizedString("main", comment: "Main section title"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(NSLocalizedString("tiles", comment: "Tiles section title"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(NSLocalizedString("sitemaps", comment: "Sitemaps section title"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(NSLocalizedString("system", comment: "System section title"))) {
                HStack {
    ...
    @State private var connectedUrl: String = NSLocalizedString("not_connected", comment: "Network not connected status") // Default label text
    @ObservedObject private var networkTracker = NetworkTracker.shared

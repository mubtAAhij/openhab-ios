...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "main_section", comment: "Main navigation section title"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "tiles_section", comment: "Tiles navigation section title"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "sitemaps_section", comment: "Sitemaps navigation section title"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "system_section", comment: "System navigation section title"))) {
                HStack {

...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "main", comment: "Main menu item")")) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "tiles", comment: "Tiles menu item")")) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "sitemaps", comment: "Sitemaps menu item")")) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "system", comment: "System menu item")")) {
                HStack {

...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "main", comment: "Main section header"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "tiles", comment: "Tiles section header"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "sitemaps", comment: "Sitemaps section header"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "system", comment: "System section header"))) {
                HStack {

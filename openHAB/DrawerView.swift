...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "main", comment: "Main navigation section title")")) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "tiles", comment: "Tiles navigation section title")")) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "sitemaps", comment: "Sitemaps navigation section title")")) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "system", comment: "System navigation section title")")) {
                HStack {

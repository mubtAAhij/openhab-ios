...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(LocalizedStringKey("main"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(LocalizedStringKey("tiles"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(LocalizedStringKey("sitemaps"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(LocalizedStringKey("system"))) {
                HStack {
    ...
    @State private var connectedUrl: String = NSLocalizedString("not_connected", comment: "Connection status when not connected") // Default label text
    @ObservedObject private var networkTracker = NetworkTracker.shared

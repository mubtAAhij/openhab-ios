...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "main_section", comment: "Main section header")")) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "tiles_section", comment: "Tiles section header")")) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "sitemaps_section", comment: "Sitemaps section header")")) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text("String(localized: "system_section", comment: "System section header")")) {
                HStack {

...
struct DrawerView: View {
    struct MainSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "main_section", comment: "Main section header in drawer"))) {
                HStack {
                    Image("openHABIcon")
                        .resizable()
                        .aspectRatio(contentMode: .fit)
    ...
    struct TilesSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "tiles_section", comment: "Tiles section header in drawer"))) {
    ...
    struct SitemapsSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "sitemaps_section", comment: "Sitemaps section header in drawer"))) {
    ...
    struct SystemSectionView: View {
        ...
        var body: some View {
            Section(header: Text(String(localized: "system_section", comment: "System section header in drawer"))) {
                HStack {
    ...
    @State private var connectedUrl: String = String(localized: "not_connected", comment: "Connection status when not connected") // Default label text
    @ObservedObject private var networkTracker = NetworkTracker.shared

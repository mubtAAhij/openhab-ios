...
class OpenHABRootViewController: UIViewController {
    ...
    private lazy var webViewController: OpenHABWebViewController = {
        let storyboard = UIStoryboard(name: "String(localized: "main", comment: "Main title")", bundle: Bundle.main)
    ...
    @objc func handleCertificateTrust(_ notification: Notification, message: String) {
        ...
        DispatchQueue.main.async {
            ...
            alert.addAction(UIAlertAction(title: "String(localized: "deny", comment: "Deny action")", style: .cancel) { _ in

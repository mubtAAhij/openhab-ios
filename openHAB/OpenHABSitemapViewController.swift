    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                title: String(localized: "enter_new_value", comment: "Alert title for entering new value"),
                message: String(localized: "current_value_for_widget", comment: "Alert message showing current widget value"),
                preferredStyle: .alert
            )
            alert.addTextField(configurationHandler: textFieldAdder)
            let sendAction = UIAlertAction(title: String(localized: "set_value", comment: "Button text to set value"), style: .destructive, handler: { [weak self] _ in

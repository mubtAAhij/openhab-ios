    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                ...
                message: "NSLocalizedString("current_value_for_widget", comment: "Message showing current widget value")",
                preferredStyle: .alert
            )
            alert.addTextField(configurationHandler: textFieldAdder)
            let sendAction = UIAlertAction(title: "NSLocalizedString("set_value", comment: "Button text to set value")", style: .destructive, handler: { [weak self] _ in

    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                ...
                message: "String(localized: "current_value_message", comment: "Message showing current value")",
                preferredStyle: .alert
            )
            alert.addTextField(configurationHandler: textFieldAdder)
            let sendAction = UIAlertAction(title: "String(localized: "set_value_button", comment: "Set value button text")", style: .destructive, handler: { [weak self] _ in

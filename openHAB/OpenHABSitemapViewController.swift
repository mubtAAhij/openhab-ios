    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                title: "String(localized: "enter_new_value", comment: "Enter new value prompt")",
                message: "String(localized: "current_value_for_widget", comment: "Current value description for widget")",

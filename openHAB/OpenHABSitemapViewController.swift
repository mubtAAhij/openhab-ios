    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                title: NSLocalizedString("enter_new_value", comment: "Prompt for entering new value"),
                message: String(format: NSLocalizedString("current_value_for_widget", comment: "Current widget value message"), widget.label, widget.state),

    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                ...
                message: "String(localized: "current_value_prompt", comment: "Message showing current value for widget")",
                preferredStyle: .alert
            )
            alert.addTextField(configurationHandler: textFieldAdder)
            let sendAction = UIAlertAction(title: "String(localized: "set_value_action", comment: "Set value button text")", style: .destructive, handler: { [weak self] _ in

    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                ...
                message: String(localized: "current_value_for_widget", comment: "Shows current widget value").replacingOccurrences(of: "%1$@", with: widget.label).replacingOccurrences(of: "%2$@", with: widget.state),

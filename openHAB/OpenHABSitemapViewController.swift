    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                ...
                message: String(localized: "current_value_for_widget", comment: "Current value message for widget").replacingOccurrences(of: "{label}", with: widget.label).replacingOccurrences(of: "{state}", with: widget.state),

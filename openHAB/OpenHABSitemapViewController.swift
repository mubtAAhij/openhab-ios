    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if widget.linkedPage != nil {
            ...
            let alert = UIAlertController(
                title: String(localized: "enter_new_value", comment: "Input dialog title"),
                message: String(localized: "current_value_for_item", comment: "Current value description in input dialog").replacingOccurrences(of: "{label}", with: widget.label).replacingOccurrences(of: "{value}", with: widget.state),

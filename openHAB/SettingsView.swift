    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text(String(localized: "enter_local_server_url", comment: "Local server URL input placeholder"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text(String(localized: "enter_remote_server_url", comment: "Remote server URL input placeholder"))
                        }
                    }

                    LabeledContent {
                        TextField(
                            String(localized: "foo", comment: "Placeholder text"),
                        ...
                        if settingsUsername.isEmpty {
                            Text(String(localized: "enter_username_placeholder", comment: "Username input placeholder"))
                        }
                    }

                    LabeledContent {
                        SecureField(
                            String(localized: "password_placeholder", comment: "Password input placeholder"),
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_on_server", comment: "Placeholder text for password field in settings"))
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text(String(localized: "ignore_ssl_certificates", comment: "Settings option to ignore SSL certificate validation"))
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text(String(localized: "always_allow_webrtc", comment: "Settings option to always allow WebRTC connections"))
                }
                ...
                LabeledContent {
                    ...
                    Text(String(localized: "default_path", comment: "Label for default path setting in Main UI"))
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text(String(localized: "sitemap_for_apple_watch", comment: "Settings label for selecting sitemap for Apple Watch"))
                }
            }
        ...
        .toolbar {
            ToolbarItemGroup(placement: .primaryAction) {
                Button(String(localized: "save", comment: "Save button text in settings")) {
                    saveSettings()
        ...
        .onAppear {
            loadSettings()
            logger.debug(String(localized: "loading_settings", comment: "Loading message when settings are being loaded"))
        }
    }

...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text(String(localized: "enter_url_local_server", comment: "Local server URL placeholder"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_help", comment: "Helper text explaining username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_help", comment: "Helper text explaining password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Toggle option to ignore SSL certificate validation")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Toggle option to always allow WebRTC connections")")
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_for_apple_watch", comment: "Label for selecting sitemap for Apple Watch")")
                }
            }
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading message while settings are being loaded")")
        }
    }

...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_for_watch", comment: "Label for Apple Watch sitemap selection")")
                }
            }
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading settings progress message")")
        }
    }

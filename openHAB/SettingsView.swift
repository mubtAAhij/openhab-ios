        ...
        Form {
            Section(header: Text(LocalizedStringKey("openhab_connection"))) {
                Toggle(isOn: $settingsDemomode) {
                    Text("String(localized: "demo_mode", comment: "Demo mode toggle label")")
                }
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_local_server_url", comment: "Placeholder text for local server URL field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_remote_url", comment: "Placeholder text for remote server URL field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_hint", comment: "Hint text for username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_hint", comment: "Hint text for password field")")
                        }
                    }

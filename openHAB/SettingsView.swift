                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text(String(localized: "enter_local_url_placeholder", comment: "Placeholder text for local server URL input"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text(String(localized: "enter_remote_url_placeholder", comment: "Placeholder text for remote server URL input"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text(String(localized: "enter_username_placeholder", comment: "Helper text for username input"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_placeholder", comment: "Helper text for password input"))
                        }
                    }

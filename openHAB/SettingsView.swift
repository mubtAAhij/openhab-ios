...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            Section(header: Text(LocalizedStringKey("openhab_connection"))) {
                Toggle(isOn: $settingsDemomode) {
                    Text("NSLocalizedString("demo_mode", comment: "Demo mode setting label")")
                }
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_remote_url", comment: "Placeholder text for remote server URL input field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_hint", comment: "Helper text for username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_hint", comment: "Helper text for password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Settings option to ignore SSL certificates")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Settings option to always allow WebRTC")")
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_for_apple_watch", comment: "Settings label for Apple Watch sitemap selection")")
                }
            }
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading message for settings screen")")
        }
    }

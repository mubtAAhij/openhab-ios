        ...
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_local_server_url", comment: "Prompt for local server URL")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Toggle option to ignore SSL certificates")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Toggle option to always allow WebRTC")")
                }

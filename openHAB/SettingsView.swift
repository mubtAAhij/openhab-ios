...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("NSLocalizedString("enter_remote_url", comment: "Placeholder text for remote server URL field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("NSLocalizedString("enter_username_hint", comment: "Help text for username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("NSLocalizedString("enter_password_hint", comment: "Help text for password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("NSLocalizedString("ignore_ssl_certificates", comment: "Settings option to ignore SSL certificate validation")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("NSLocalizedString("always_allow_webrtc", comment: "Settings option to always allow WebRTC connections")")
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("NSLocalizedString("sitemap_for_watch", comment: "Label for Apple Watch sitemap selection")")
                }
            }
        ...
        .onAppear {
            loadSettings()
            logger.debug("NSLocalizedString("loading_settings", comment: "Text shown while settings are loading")")
        }
    }

...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_help", comment: "Help text for username input field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_help", comment: "Help text for password input field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                ...
                LabeledContent {
                    ...
                    Text("String(localized: "default_path", comment: "Label for default Main UI path setting")")
                }
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading indicator text for settings")")
        }
    }

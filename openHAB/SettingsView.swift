        ...
        Form {
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_on_server", comment: "Helper text for password field"))
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text(String(localized: "always_allow_webrtc", comment: "Toggle label for WebRTC setting"))
                }

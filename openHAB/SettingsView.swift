        ...
        Form {
            Section(header: Text(LocalizedStringKey("openhab_connection"))) {
                Toggle(isOn: $settingsDemomode) {
                    Text(String(localized: "demo_mode", comment: "Toggle for demo mode"))
                }
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text(String(localized: "enter_username_hint", comment: "Hint text for username input"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_hint", comment: "Hint text for password input"))
                        }
                    }

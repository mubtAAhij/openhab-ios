        ...
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_local_server_url", comment: "Placeholder text for local server URL input")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_remote_server_url", comment: "Placeholder text for remote server URL input")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_if_required", comment: "Placeholder text for username input")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_server_password", comment: "Placeholder text for password input")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Setting to ignore SSL certificate errors")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                ...
                LabeledContent {
                    ...
                    Text("String(localized: "default_path", comment: "Default path setting label")")
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_for_apple_watch", comment: "Setting for Apple Watch sitemap selection")")
                }
            }

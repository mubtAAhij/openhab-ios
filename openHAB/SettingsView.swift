        ...
        Form {
            Section(header: Text(LocalizedStringKey("openhab_connection"))) {
                Toggle(isOn: $settingsDemomode) {
                    Text(String(localized: "demo_mode", comment: "Toggle for demo mode functionality"))
                }
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text(String(localized: "enter_username_if_required", comment: "Help text for username input field"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_on_server", comment: "Help text for password input field"))
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text(String(localized: "ignore_ssl_certificates", comment: "Toggle for ignoring SSL certificate validation"))
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text(String(localized: "always_allow_webrtc", comment: "Toggle for always allowing WebRTC connections"))
                }

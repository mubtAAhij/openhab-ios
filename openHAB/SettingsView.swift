                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_url_of_local_server", comment: "Local server URL placeholder")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_url_remote_server", comment: "Placeholder text for remote server URL field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_on_server", comment: "Help text for password field")")
                        }
                    }

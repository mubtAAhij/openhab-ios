                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text(String(localized: "enter_local_url", comment: "Placeholder text for local server URL input"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text(String(localized: "enter_username_hint", comment: "Helper text for username input field"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text(String(localized: "enter_password_hint", comment: "Helper text for password input field"))
                        }
                    }

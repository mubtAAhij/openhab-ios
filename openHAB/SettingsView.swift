...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_local_server_url", comment: "Placeholder for local server URL")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_help", comment: "Help text for username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_help", comment: "Help text for password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_apple_watch", comment: "Setting for Apple Watch sitemap")")
                }
            }
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading settings message")")
        }
    }

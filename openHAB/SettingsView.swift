                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text("String(localized: "enter_local_url", comment: "Placeholder text for local server URL field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password", comment: "Help text for password field")")
                        }
                    }

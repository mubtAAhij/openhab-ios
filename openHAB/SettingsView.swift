    ...
    var body: some View {
        Form {
                ...
                if !settingsDemomode {
                    LabeledContent {
                        ...
                        if settingsLocalUrl.isEmpty {
                            Text(NSLocalizedString("enter_url_local_server", comment: "Placeholder text for local server URL"))
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_remote_server_url", comment: "Placeholder text for remote server URL field")")
                        }
                    }

                    LabeledContent {
                        TextField(
                            "String(localized: "username_placeholder", comment: "Placeholder text for username field")",
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_if_required", comment: "Help text for username field")")
                        }
                    }

                    LabeledContent {
                        SecureField(
                            "String(localized: "password_placeholder", comment: "Placeholder text for password field")",
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_server_password", comment: "Help text for password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Toggle label for ignoring SSL certificates")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Toggle label for always allowing WebRTC")")
                }
                ...
                LabeledContent {
                    ...
                    Text("String(localized: "default_path", comment: "Label for default MainUI path setting")")
                }
            ...
            Section(header: Text(LocalizedStringKey("sitemap_settings"))) {
                ...
                Picker(selection: $settingsSitemapForWatch) {
                    ...
                    Text("String(localized: "sitemap_for_apple_watch", comment: "Label for Apple Watch sitemap selection")")
                }
            }
        ...
        .toolbar {
            ToolbarItemGroup(placement: .primaryAction) {
                Button("String(localized: "save", comment: "Save button label")") {
                    saveSettings()
        ...
        .onAppear {
            loadSettings()
            logger.debug("String(localized: "loading_settings", comment: "Loading message for settings")")
        }
    }

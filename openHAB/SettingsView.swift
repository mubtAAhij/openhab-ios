        ...
        Form {
            Section(header: Text(LocalizedStringKey("openhab_connection"))) {
                Toggle(isOn: $settingsDemomode) {
                    Text("String(localized: "demo_mode", comment: "Toggle for demo mode setting")")
                }
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_hint", comment: "Help text for username field")")
                        }
                    }
                    ...
                    LabeledContent {
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_hint", comment: "Help text for password field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Toggle for ignoring SSL certificates")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Toggle for always allowing WebRTC")")
                }

        ...
        Form {
                ...
                if !settingsDemomode {
                    ...
                    LabeledContent {
                        ...
                        if settingsRemoteUrl.isEmpty {
                            Text("String(localized: "enter_remote_url", comment: "Placeholder text for remote server URL input")")
                        }
                    }

                    LabeledContent {
                        TextField(
                            "String(localized: "username_placeholder", comment: "Placeholder text for username input")",
                        ...
                        if settingsUsername.isEmpty {
                            Text("String(localized: "enter_username_hint", comment: "Help text for username input field")")
                        }
                    }

                    LabeledContent {
                        SecureField(
                            "String(localized: "password_placeholder", comment: "Placeholder text for password input")",
                        ...
                        if settingsPassword.isEmpty {
                            Text("String(localized: "enter_password_hint", comment: "Help text for password input field")")
                        }
                    }
            ...
            Section(header: Text(LocalizedStringKey("application_settings"))) {
                Toggle(isOn: $settingsIgnoreSSL) {
                    Text("String(localized: "ignore_ssl_certificates", comment: "Setting to ignore SSL certificates")")
                }
            ...
            Section(header: Text(LocalizedStringKey("mainui_settings"))) {
                Toggle(isOn: $settingsAlwaysAllowWebRTC) {
                    Text("String(localized: "always_allow_webrtc", comment: "Setting to always allow WebRTC")")
                }

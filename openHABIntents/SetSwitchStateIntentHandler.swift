...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTIString(localized: "on_intent", comment: "ON value for intent handling")_MAP = [String(localized: "on_intent", comment: "ON value for intent handling"): "String(localized: "on_intent", comment: "ON value for intent handling")", String(localized: "off_intent", comment: "OFF value for intent handling"): "String(localized: "off_intent", comment: "OFF value for intent handling")"] // these are the sent items - do not translate this text

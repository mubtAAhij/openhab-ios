...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: String(localized: "on", comment: "ON state"), OFF: String(localized: "off", comment: "OFF state")] // these are the sent items - do not translate this text

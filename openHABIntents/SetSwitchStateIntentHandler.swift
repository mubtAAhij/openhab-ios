...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: NSLocalizedString("on", comment: "Switch on state"), OFF: NSLocalizedString("off", comment: "Switch off state")] // these are the sent items - do not translate this text

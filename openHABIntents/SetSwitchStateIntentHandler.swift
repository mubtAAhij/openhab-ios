...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: NSLocalizedString("on", comment: "ON state"), OFF: NSLocalizedString("off", comment: "OFF state")] // these are the sent items - do not translate this text

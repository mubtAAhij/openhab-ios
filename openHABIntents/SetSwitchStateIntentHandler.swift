...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: NSLocalizedString("on", comment: "ON state for intent"), OFF: NSLocalizedString("off", comment: "OFF state for intent")] // these are the sent items - do not translate this text

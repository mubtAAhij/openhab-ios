...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: String(localized: "on", comment: "ON state for switch intent"), OFF: String(localized: "off", comment: "OFF state for switch intent")] // these are the sent items - do not translate this text

...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTIString(localized: "on", comment: "ON state for intent")_MAP = [String(localized: "on", comment: "ON state for intent"): "String(localized: "on", comment: "ON state for intent")", String(localized: "off", comment: "OFF state for intent"): "String(localized: "off", comment: "OFF state for intent")"] // these are the sent items - do not translate this text

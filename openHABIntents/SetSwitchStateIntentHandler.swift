...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTION_MAP = [ON: String(localized: "on", comment: "Switch state ON"), OFF: String(localized: "off", comment: "Switch state OFF")] // these are the sent items - do not translate this text

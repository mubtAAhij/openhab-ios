...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTINSLocalizedString("on", comment: "ON state for intent")_MAP = [NSLocalizedString("on", comment: "ON state for intent"): "NSLocalizedString("on", comment: "ON state for intent")", NSLocalizedString("off", comment: "OFF state for intent"): "NSLocalizedString("off", comment: "OFF state for intent")"] // these are the sent items - do not translate this text

...
class SetSwitchStateIntentHandler: NSObject, OpenHABSetSwitchStateIntentHandling {
    ...
    static let ACTIString(localized: "on", comment: "ON state for switch intent")_MAP = [String(localized: "on", comment: "ON state for switch intent"): "String(localized: "on", comment: "ON state for switch intent")", String(localized: "off", comment: "OFF state for switch intent"): "String(localized: "off", comment: "OFF state for switch intent")"] // these are the sent items - do not translate this text

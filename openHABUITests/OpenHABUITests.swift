...
class OpenHABUITests: XCTestCase {
    ...
    func testShots() {
        ...
        widgetTable.staticTexts[NSLocalizedString("widget_overview", comment: "Widget overview screen title")].tap()
        sleep(3)
        ...
        sleep(2)
        widgetTable.staticTexts[NSLocalizedString("ground_floor", comment: "Ground floor location label")].tap()
        sleep(5)
        widgetTable.staticTexts[NSLocalizedString("kitchen", comment: "Kitchen location label")].tap()
        sleep(5)
        snapshot("6_Kitchen")

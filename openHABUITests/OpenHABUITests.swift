...
class OpenHABUITests: XCTestCase {
    ...
    func testShots() {
        ...
        widgetTable.staticTexts["String(localized: "widget_overview", comment: "Widget overview section title")"].tap()
        sleep(3)
        ...
        sleep(2)
        widgetTable.staticTexts["String(localized: "ground_floor", comment: "Ground floor location name")"].tap()
        sleep(5)
        widgetTable.staticTexts["String(localized: "kitchen", comment: "Kitchen location name")"].tap()
        sleep(5)
        snapshot("6_Kitchen")

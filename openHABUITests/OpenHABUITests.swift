...
class OpenHABUITests: XCTestCase {
    ...
    func testShots() {
        ...
        widgetTable.staticTexts[String(localized: "widget_overview", comment: "Widget overview navigation title")].tap()
        sleep(3)
        widgetTable.staticTexts[String(localized: "binary_widgets", comment: "Binary widgets section header")].swipeDown()
        sleep(6)
        snapshot("5_WidgetOverview")

        app.navigationBars.buttons.element(boundBy: 0).tap()
        sleep(2)
        widgetTable.staticTexts[String(localized: "ground_floor", comment: "Ground floor navigation item")].tap()
        sleep(5)
        widgetTable.staticTexts[String(localized: "kitchen", comment: "Kitchen navigation item")].tap()
        sleep(5)
        snapshot("6_Kitchen")

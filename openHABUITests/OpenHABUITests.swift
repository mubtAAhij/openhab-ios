...
class OpenHABUITests: XCTestCase {
    ...
    func testShots() {
        ...
        widgetTable.staticTexts["String(localized: "widget_overview", comment: "Widget overview screen title")"].tap()
        sleep(3)
        ...
        sleep(2)
        widgetTable.staticTexts["String(localized: "ground_floor", comment: "Ground floor location label")"].tap()
        sleep(5)
        widgetTable.staticTexts["String(localized: "kitchen", comment: "Kitchen location label")"].tap()
        sleep(5)
        snapshot("6_Kitchen")

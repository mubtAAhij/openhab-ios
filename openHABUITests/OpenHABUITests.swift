...
class OpenHABUITests: XCTestCase {
    ...
    func testShots() {
        ...
        sleep(2)
        widgetTable.staticTexts["NSLocalizedString("ground_floor", comment: "Ground floor location")"].tap()
        sleep(5)
        widgetTable.staticTexts["NSLocalizedString("kitchen", comment: "Kitchen location")"].tap()
        sleep(5)
        snapshot("6_Kitchen")

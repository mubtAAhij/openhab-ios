...
class PrefsInterfaceController: WKInterfaceController {
    ...
    func displayTheApplicationVersionNumber() {
        ...
        versionLabel.setText("String(localized: "version_format", comment: "Version format string").replacingOccurrences(of: "{version}", with: versionNumber).replacingOccurrences(of: "{build}", with: buildNumber)")
    }
}

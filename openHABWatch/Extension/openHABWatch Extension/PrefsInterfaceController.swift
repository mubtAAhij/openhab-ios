...
class PrefsInterfaceController: WKInterfaceController {
    ...
    func displayTheApplicationVersionNumber() {
        ...
        versionLabel.setText("String(localized: "version_format", comment: "Version format string").replacingOccurrences(of: "%1", with: "\(versionNumber)").replacingOccurrences(of: "%2", with: "\(buildNumber)")")
    }
}

...
class PrefsInterfaceController: WKInterfaceController {
    ...
    func displayTheApplicationVersionNumber() {
        ...
        versionLabel.setText(String(localized: "version_format", comment: "Version number format display").replacingOccurrences(of: "{version}", with: versionNumber).replacingOccurrences(of: "{build}", with: buildNumber))
    }
}

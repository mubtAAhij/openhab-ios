...
class PrefsInterfaceController: WKInterfaceController {
    ...
    func displayTheApplicationVersionNumber() {
        ...
        versionLabel.setText(String(localized: "version_build_format", comment: "Version and build number format").replacingOccurrences(of: "{version}", with: versionNumber).replacingOccurrences(of: "{build}", with: buildNumber))
    }
}

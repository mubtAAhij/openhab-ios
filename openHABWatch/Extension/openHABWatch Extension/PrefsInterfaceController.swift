...
class PrefsInterfaceController: WKInterfaceController {
    ...
    func displayTheApplicationVersionNumber() {
        ...
        versionLabel.setText(String(localized: "version_format", comment: "Format string for version display").replacingOccurrences(of: "{version}", with: versionNumber).replacingOccurrences(of: "{build}", with: buildNumber))
    }
}

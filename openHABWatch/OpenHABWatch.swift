        ...
        WindowGroup {
            TabView {
                ...
                PreferencesSwiftUIView()
                    .tabItem {
                        Label(NSLocalizedString("preferences", comment: "Preferences tab title"), systemSymbol: .circleFill)
                    }
                LogsViewer()
                    .tabItem {
                        Label(NSLocalizedString("debug", comment: "Debug tab title"), systemSymbol: .circleFill)
                    }
            }
            .tabViewStyle(.page)

        ...
        WindowGroup {
            TabView {
                ...
                PreferencesSwiftUIView()
                    .tabItem {
                        Label("String(localized: "preferences", comment: "Preferences menu title on watch")", systemSymbol: .circleFill)
                    }
                LogsViewer()
                    .tabItem {
                        Label("String(localized: "debug", comment: "Debug menu title")", systemSymbol: .circleFill)
                    }
            }
            .tabViewStyle(.page)

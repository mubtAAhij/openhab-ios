        ...
        WindowGroup {
            TabView {
                ...
                PreferencesSwiftUIView()
                    .tabItem {
                        Label("NSLocalizedString("preferences", comment: "Preferences menu item")", systemSymbol: .circleFill)
                    }
                LogsViewer()
                    .tabItem {
                        Label("NSLocalizedString("debug", comment: "Debug menu item")", systemSymbol: .circleFill)
                    }
            }
            .tabViewStyle(.page)

        ...
        WindowGroup {
            TabView {
                ...
                PreferencesSwiftUIView()
                    .tabItem {
                        Label("String(localized: "preferences", comment: "Watch preferences title")", systemSymbol: .circleFill)
                    }
                LogsViewer()
                    .tabItem {
                        Label("String(localized: "debug", comment: "Watch debug title")", systemSymbol: .circleFill)
                    }
            }
            .tabViewStyle(.page)

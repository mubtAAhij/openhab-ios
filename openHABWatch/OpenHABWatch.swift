        ...
        WindowGroup {
            TabView {
                ...
                PreferencesSwiftUIView()
                    .tabItem {
                        Label("String(localized: "preferences", comment: "Preferences screen title")", systemSymbol: .circleFill)
                    }
                LogsViewer()
                    .tabItem {
                        Label("String(localized: "debug", comment: "Debug screen title")", systemSymbol: .circleFill)
                    }
            }
            .tabViewStyle(.page)

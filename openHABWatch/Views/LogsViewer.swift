...
public extension Logger {
    static func fetch(since date: Date,
        ...
        if logs.isEmpty { logs = ["String(localized: "nothing_found", comment: "No logs found message")"] }
        return logs
    }
}
...
struct LogsViewer: View {
    ...
    private func fetchLogs() async -> String {
        ...
        guard let dayAgo = calendar.date(
            ...
            return "String(localized: "invalid_calendar", comment: "Invalid calendar error message")"
        }

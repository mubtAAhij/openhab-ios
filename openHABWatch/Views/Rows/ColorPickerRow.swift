...
struct ColorPickerRow: View {
    ...
    func upButtonPressed() {
        ...
        widget.sendCommand("String(localized: "on_state", comment: "Color picker ON state")")
    }

    func downButtonPressed() {
        os_log("OFF button pressed", log: .command, type: .info)
        widget.sendCommand("String(localized: "off_state", comment: "Color picker OFF state")")
    }
}

        ...
        .init(
            ...
            set: {
                if $0 {
                    ...
                    widget.sendCommand("String(localized: "switch_on", comment: "Switch ON state in switch row")")
                } else {
                    os_log("Switch to OFF", log: .viewCycle, type: .info)
                    widget.sendCommand("String(localized: "switch_off", comment: "Switch OFF state in switch row")")
                }
